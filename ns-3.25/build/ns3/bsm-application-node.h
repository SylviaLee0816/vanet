...
#ifndef BSM_APPLICATION_NODE_H
#define BSM_APPLICATION_NODE_H
 ...
 */
class BsmApplicationNode : public Application
{
public:
   ...
   */
  BsmApplicationNode ();
  virtual ~BsmApplicationNode ();
  
  void Setup (NodeContainer & i,
              int nodeId,
              Time totalTime,
...
private:
   ...
   * \return none
   */
  void GenerateWaveTraffic (uint32_t pktSize,
   ...
   * \return none
   */
  bool ReceiveWavePacket (Ptr<NetDevice> dev, Ptr<const Packet> pkt, uint16_t mode, const Address &sender);
