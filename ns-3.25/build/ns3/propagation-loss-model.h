...
class HighwayPropagationLossModel : public PropagationLossModel
{
public:
        /**
         * \brief Get the type ID.
        ...
        HighwayPropagationLossModel ();
        virtual ~HighwayPropagationLossModel ();
         ...
         * \param frequency (Hz)
         *
         * Set the carrier frequency used in the HighwayLosLoss Model
         * calculation.
         */
        void SetFrequency (double frequency);
...
private:
     ...
     * Defined and unimplemented to avoid misuse
     */
    HighwayPropagationLossModel (const HighwayPropagationLossModel&);
    /**
     * \brief Copy constructor
     *
     * Defined and unimplemented to avoid misuse
     * \returns
     */
    HighwayPropagationLossModel& operator= (const HighwayPropagationLossModel&);
...
private:
    double m_antennaEffectiveHeight;
    ...
    double m_slow_shading_delta;
    double m_slow_shading_cor_dis;
    

};
    
    
class CityPropagationLossModel : public PropagationLossModel
{
public:
    /**
     * \brief Get the type ID.
    ...
    CityPropagationLossModel ();
    virtual ~CityPropagationLossModel ();
     ...
     * \param frequency (Hz)
     *
     * Set the carrier frequency used in the CityNlosLossModel Model
     * calculation.
     */
    void SetFrequency (double frequency);
...
private:
     ...
     * Defined and unimplemented to avoid misuse
     */
    CityPropagationLossModel (const CityPropagationLossModel&);
    /**
     * \brief Copy constructor
     *
     * Defined and unimplemented to avoid misuse
     * \returns
     */
    CityPropagationLossModel& operator= (const CityPropagationLossModel&);
    
    virtual double DoCalcRxPower (double txPowerDbm,
                                  Ptr<MobilityModel> a,
                                  Ptr<MobilityModel> b) const;
    virtual double city_nlos_pathloss_calc(float lvf_distance)const;
    virtual double DoCalcLosRxPower(double txPowerDbm,
                                               Ptr<MobilityModel> a,
                                               Ptr<MobilityModel> b)const;
    virtual int64_t DoAssignStreams (int64_t stream);
...
private:
    ...
    double m_nlos_slow_shading_delta;
    double m_los_slow_shading_delta;
    double m_slow_shading_cor_dis;
