...
public:
  ...
  void DoSetAppControl (Ptr<ApplicationControl> control);

  Ptr<ApplicationControl> DoGetAppControl (void) const;
...
private:
  ...
  mutable int sharedId;
  Ptr<ApplicationControl> m_control;
};
